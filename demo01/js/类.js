...
// ⅰ. public: 修饰的属性和方法是公有的,可以在任何地方被访问到，默认所有的属性和方法都是公有的.
// ⅱ. private: 修饰的属性个方法是私有的，不能在声明它的类的外部访问.
// ⅲ. protected修饰的属性和方法是受保护的,它和private相似，区别是他在子类中也是允许访问的.
...
// let p = new Father2('18');
// p.age // 18
// p.age = 19;
// p.age // 19
// 2.如果把name的定义改为private会发生什么呢？
var Father3 = /** @class */ (function () {
    function Father3(age) {
        this.age = 18;
    }
    return Father3;
}());
var p3 = new Father3('18');
// p3.age //这时候编译器就会给我们报一个提示，属性“age”为私有属性，只能在类“Father”中访问，编译后还是可以正常执行的
// 3.那么在子类可以访问age变量嘛？可以看到，在编译器中会给我们提示.
var Father4 = /** @class */ (function () {
    function Father4(age) {
        this.age = age;
    }
    return Father4;
}());
var p4 = new Father4('18');
var Son1 = /** @class */ (function (_super) {
    __extends(Son1, _super);
    function Son1(age) {
        return _super.call(this, age) || this;
        // console.log('age:' + this.age);// 报错属性“age”为私有属性，只能在类“Father”中访问。
    }
    return Son1;
}(Father4));
new Son1('18');
...
var Father5 = /** @class */ (function () {
    function Father5(age) {
        this.age = 18;
    }
    return Father5;
}());
// new Father5('18'); //类“Father”的构造函数是私有的，仅可在类声明中访问。
// 5.当构造函数修饰为private时，该类不允许被被继承
var Father6 = /** @class */ (function () {
    function Father6(age) {
        this.age = 18;
    }
    return Father6;
}());
// class Son extends Father6 {//无法扩展类“Father”。类构造函数标记为私有。
//     constructor (age) {
//         super(age);
...
// class Father7 {
//     protected age;
//     public constructor (age: string) {
//         this.age = 18;
//     }
// }
// let p = new Father7('18');
// class Son extends Father7 {
//     constructor (age) {
//         super(age);
